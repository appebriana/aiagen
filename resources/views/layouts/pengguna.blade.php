        ...
        <div class="min-h-screen bg-secondary-200 flex" 
            ...
            <div class="lg:hidden fixed bottom-6 left-6 right-6 z-[100] bg-white/80 backdrop-blur-2xl border border-white/50 rounded-2xl shadow-[0_15px_35px_rgba(0,0,0,0.1)] px-3 py-2">
                <div class="flex items-center justify-around">
                    <a href="{{ route('pengguna.dashboard') }}" 
                       class="flex flex-col items-center gap-0.5 py-1 px-2 rounded-2xl transition-all {{ request()->routeIs('pengguna.dashboard') && !request()->is('*/ai-agen*') ? 'text-primary-600 bg-primary-50' : 'text-secondary-400' }}">
                    ...
                    <a href="{{ route('pengguna.pengaturan.index') }}" 
                       class="flex flex-col items-center gap-0.5 py-1 px-2 rounded-2xl transition-all {{ request()->is('*/pengaturan*') || request()->routeIs('pengguna.profile.*') ? 'text-primary-600 bg-primary-50' : 'text-secondary-400' }}">
                        ...
                        <div class="flex flex-col gap-2 mb-6">
                            ...
                            <div x-data="{ isLaporanOpen: {{ request()->routeIs('*.laporan.*') ? 'true' : 'false' }} }">
                                ...
                                <div x-show="isLaporanOpen" x-transition class="mt-2 ml-4 pl-4 border-l-2 border-primary-100 space-y-1">
                                    <a href="{{ route('pengguna.laporan.interaksi.wa') }}"
            ...
            <div class="flex-1 flex flex-col transition-all duration-300 min-w-0" :class="sidebarOpen ? 'lg:ml-64' : 'lg:ml-20'">
                ...
                <header class="sticky top-0 z-20 bg-white/80 backdrop-blur-md border-b border-secondary-300 h-16 flex items-center justify-between px-4 sm:px-6 lg:px-8 shadow-sm">
                    ...
                    <div class="hidden lg:flex items-center gap-2">
                        <a href="{{ route('pengguna.dashboard') }}" 
                           class="px-3 py-1.5 rounded-lg text-sm font-semibold transition-colors flex items-center gap-2 {{ request()->routeIs('pengguna.dashboard') && !request()->is('*/ai-agen*') && !request()->is('*/pengaturan*') && !request()->is('*/laporan*') ? 'bg-primary-100 text-primary-700' : 'text-secondary-600 hover:bg-secondary-100' }}">
