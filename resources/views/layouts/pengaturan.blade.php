            ...
            <div class="transition-all duration-300 min-w-0" :class="sidebarOpen ? 'lg:ml-64' : 'lg:ml-20'">
                ...
                <header class="fixed top-0 left-0 right-0 z-20 bg-white/80 backdrop-blur-md border-b border-secondary-300/50 h-16 flex items-center justify-between px-4 sm:px-6 lg:px-8 transition-all duration-300"
                    ...
                    <div class="hidden lg:flex items-center gap-2">
                        ...
                        <a href="{{ auth()->user()->isAdmin() ? route('admin.ai-agen.index') : route('pengguna.ai-agen.index') }}" 
                           class="px-3 py-1.5 rounded-lg text-sm font-semibold transition-colors {{ request()->is('*/ai-agen*') || request()->is('*/laporan*') ? 'bg-primary-100 text-primary-700' : 'text-secondary-600 hover:bg-primary-100' }}">
                            AI Agen
                        </a>
                        <a href="{{ auth()->user()->isAdmin() ? route('admin.pengaturan.index') : route('pengguna.pengaturan.index') }}" 
