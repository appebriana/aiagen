...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <title>{{ config('app.name', 'AIAGEN') }} â€” Pengaturan</title>
                ...
                <div class="bg-white/90 backdrop-blur-2xl rounded-2xl shadow-[10px_10px_40px_rgba(0,0,0,0.12)] border border-white/50 flex flex-col h-full">
                    ...
                    <div class="p-5 overflow-y-auto flex-1 scrollbar-hide">
                        ...
                        <div class="flex flex-col gap-2 mb-6">
                            <a href="{{ auth()->user()->isAdmin() ? route('admin.dashboard') : route('pengguna.dashboard') }}" class="flex items-center gap-4 p-3 rounded-2xl transition-all duration-300 active:scale-95 {{ request()->routeIs('*.dashboard') && !request()->is('*/ai-agen*') ? 'bg-primary-600 text-white shadow-lg shadow-primary-200' : 'bg-secondary-50 text-secondary-600 hover:bg-secondary-100' }}">
                            ...
                            <a href="{{ auth()->user()->isAdmin() ? route('admin.ai-agen.index') : route('pengguna.ai-agen.index') }}" class="flex items-center gap-4 p-3 rounded-2xl transition-all duration-300 active:scale-95 {{ request()->is('*/ai-agen*') ? 'bg-primary-600 text-white shadow-lg shadow-primary-200' : 'bg-secondary-50 text-secondary-600 hover:bg-secondary-100' }}">
                            ...
                            <a href="{{ auth()->user()->isAdmin() ? route('admin.profile.edit') : route('pengguna.profile.edit') }}" class="flex items-center gap-4 p-3 rounded-2xl transition-all duration-300 active:scale-95 {{ request()->routeIs('*.profile.edit') ? 'bg-primary-600 text-white shadow-lg shadow-primary-200' : 'bg-secondary-50 text-secondary-600 hover:bg-secondary-100' }}">
                            ...
                            <a href="{{ auth()->user()->isAdmin() ? route('admin.pengaturan.index') : route('pengguna.pengaturan.index') }}" class="flex items-center gap-4 p-3 rounded-2xl transition-all duration-300 active:scale-95 {{ request()->is('*/pengaturan*') ? 'bg-primary-600 text-white shadow-lg shadow-primary-200' : 'bg-secondary-50 text-secondary-600 hover:bg-secondary-100' }}">
