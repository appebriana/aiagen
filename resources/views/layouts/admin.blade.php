        ...
        <div class="min-h-screen bg-secondary-200 flex" 
            ...
            <aside
                ...
                <nav class="flex-1 overflow-y-auto py-4 px-3 space-y-1 scrollbar-hide">
                    ...
                    <a href="{{ route('admin.ai-agen.index') }}"
                       class="flex items-center gap-3 px-3 py-2.5 rounded-lg text-sm font-medium transition-colors
                              {{ request()->is('admin/ai-agen*') ? 'bg-primary-700 text-white' : 'text-primary-300 hover:bg-primary-800 hover:text-white' }}">
                    ...
                    <a href="{{ route('admin.feedback.index') }}"
                       class="flex items-center gap-3 px-3 py-2.5 rounded-lg text-sm font-medium transition-colors
                              {{ request()->routeIs('admin.feedback.index') ? 'bg-primary-700 text-white' : 'text-primary-300 hover:bg-primary-800 hover:text-white' }}">
                        <svg class="w-5 h-5 flex-shrink-0" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" d="M7 8h10M7 12h4m1 8l-4-4H5a2 2 0 01-2-2V6a2 2 0 012-2h14a2 2 0 012 2v8a2 2 0 01-2 2h-3l-4 4z"/></svg>
                        <span x-show="sidebarOpen" x-cloak>Masukan Pengguna</span>
                    </a>
                </nav>
            ...
            <div class="lg:hidden fixed bottom-6 left-6 right-6 z-[100] bg-white/80 backdrop-blur-2xl border border-white/50 rounded-2xl shadow-[0_15px_35px_rgba(0,0,0,0.1)] px-3 py-2">
                <div class="flex items-center justify-around">
                    <a href="{{ route('admin.dashboard') }}" 
                       class="flex flex-col items-center gap-0.5 py-1 px-2 rounded-2xl transition-all {{ request()->routeIs('admin.dashboard') && !request()->is('*/ai-agen*') ? 'text-primary-600 bg-primary-50' : 'text-secondary-400' }}">
                        <svg class="w-5 h-5" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" d="M3 12l2-2m0 0l7-7 7 7M5 10v10a1 1 0 001 1h3m10-11l2 2m-2-2v10a1 1 0 01-1 1h-3m-6 0a1 1 0 001-1v-4a1 1 0 011-1h2a1 1 0 011 1v4a1 1 0 001 1m-6 0h6"/></svg>
                        <span class="text-[9px] font-bold">Beranda</span>
                    </a>

                    <a href="{{ route('admin.ai-agen.index') }}" 
                       class="flex flex-col items-center gap-0.5 py-1 px-2 rounded-2xl transition-all {{ request()->is('*/ai-agen*') && !request()->is('*/cms*') ? 'text-primary-600 bg-primary-50' : 'text-secondary-400' }}">
                    ...
                    <a href="{{ route('admin.pengaturan.index') }}" 
                       class="flex flex-col items-center gap-0.5 py-1 px-2 rounded-2xl transition-all {{ request()->is('*/pengaturan*') || request()->routeIs('admin.profile.*') || request()->routeIs('admin.users.*') ? 'text-primary-600 bg-primary-50' : 'text-secondary-400' }}">
            ...
            {{-- Aesthetic Left Floating Sidebar (Mobile Only) --}}
            <div x-show="mobileSidebar" x-cloak
                ...
                <div class="bg-white/90 backdrop-blur-2xl rounded-2xl shadow-[10px_10px_40px_rgba(0,0,0,0.12)] border border-white/50 flex flex-col h-full">
                    ...
                    <div class="p-5 overflow-y-auto flex-1 scrollbar-hide">
                        ...
                        <div class="flex flex-col gap-2 mb-6">
                            <a href="{{ route('admin.dashboard') }}" class="flex items-center gap-4 p-3 rounded-2xl transition-all duration-300 active:scale-95 {{ request()->routeIs('admin.dashboard') && !request()->is('*/ai-agen*') ? 'bg-primary-600 text-white shadow-lg shadow-primary-200' : 'bg-secondary-50 text-secondary-600 hover:bg-secondary-100' }}">
                            ...
                            <a href="{{ route('admin.ai-agen.index') }}" class="flex items-center gap-4 p-3 rounded-2xl transition-all duration-300 active:scale-95 {{ request()->is('*/ai-agen*') ? 'bg-primary-600 text-white shadow-lg shadow-primary-200' : 'bg-secondary-50 text-secondary-600 hover:bg-secondary-100' }}">
                            ...
                            <a href="{{ route('admin.profile.edit') }}" class="flex items-center gap-4 p-3 rounded-2xl transition-all duration-300 active:scale-95 {{ request()->routeIs('admin.profile.edit') ? 'bg-primary-600 text-white shadow-lg shadow-primary-200' : 'bg-secondary-50 text-secondary-600 hover:bg-secondary-100' }}">
                            ...
                            <a href="{{ route('admin.feedback.index') }}" class="flex items-center gap-4 p-3 rounded-2xl transition-all duration-300 active:scale-95 {{ request()->routeIs('admin.feedback.index') ? 'bg-primary-600 text-white shadow-lg shadow-primary-200' : 'bg-secondary-50 text-secondary-600 hover:bg-secondary-100' }}">
                                ...
                                <span class="font-bold text-sm">Masukan Pengguna</span>
                            </a>

                            <a href="{{ route('admin.pengaturan.index') }}" class="flex items-center gap-4 p-3 rounded-2xl transition-all duration-300 active:scale-95 {{ request()->is('*/pengaturan*') ? 'bg-primary-600 text-white shadow-lg shadow-primary-200' : 'bg-secondary-50 text-secondary-600 hover:bg-secondary-100' }}">
            ...
            <div class="flex-1 flex flex-col transition-all duration-300 min-w-0" :class="sidebarOpen ? 'lg:ml-64' : 'lg:ml-20'">
                ...
                <header class="sticky top-0 z-20 bg-white/80 backdrop-blur-md border-b border-secondary-300 h-16 flex items-center justify-between px-4 sm:px-6 lg:px-8 shadow-sm">
                    ...
                    <div class="hidden lg:flex items-center gap-2">
                        <a href="{{ route('admin.dashboard') }}" 
                           class="px-3 py-1.5 rounded-lg text-sm font-semibold transition-colors flex items-center gap-2 {{ request()->routeIs('admin.dashboard') && !request()->is('*/ai-agen*') && !request()->is('*/pengaturan*') ? 'bg-primary-100 text-primary-700' : 'text-secondary-600 hover:bg-secondary-100' }}">
                        ...
                        <a href="{{ route('admin.ai-agen.index') }}" 
                           class="px-3 py-1.5 rounded-lg text-sm font-semibold transition-colors flex items-center gap-2 {{ request()->is('*/ai-agen*') && !request()->is('*/cms*') ? 'bg-primary-100 text-primary-700' : 'text-secondary-600 hover:bg-secondary-100' }}">
                        ...
                        <a href="{{ route('admin.pengaturan.index') }}" 
                           class="px-3 py-1.5 rounded-lg text-sm font-semibold transition-colors flex items-center gap-2 {{ request()->is('*/pengaturan*') || request()->routeIs('admin.profile.*') || request()->routeIs('admin.users.*') ? 'bg-primary-100 text-primary-700' : 'text-secondary-600 hover:bg-secondary-100' }}">
                            <svg class="w-4 h-4" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" d="M10.325 4.317c.426-1.756 2.924-1.756 3.35 0a1.724 1.724 0 002.573 1.066c1.543-.94 3.31.826 2.37 2.37a1.724 1.724 0 001.065 2.572c1.756.426 1.756 2.924 0 3.35a1.724 1.724 0 00-1.066 2.573c.94 1.543-.826 3.31-2.37 2.37a1.724 1.724 0 00-2.572 1.065c-.426 1.756-2.924 1.756-3.35 0a1.724 1.724 0 00-2.573-1.066c-1.543.94-3.31-.826-2.37-2.37a1.724 1.724 0 00-1.065-2.572c-1.756-.426-1.756-2.924 0-3.35a1.724 1.724 0 001.066-2.573c-.94-1.543.826-3.31 2.37-2.37.996.608 2.296.07 2.572-1.065z"/><path stroke-linecap="round" stroke-linejoin="round" d="M15 12a3 3 0 11-6 0 3 3 0 016 0z"/></svg>
                            Pengaturan
                        </a>
                        <a href="{{ route('admin.feedback.index') }}" 
                           class="px-3 py-1.5 rounded-lg text-sm font-semibold transition-colors flex items-center gap-2 {{ request()->routeIs('admin.feedback.index') ? 'bg-primary-100 text-primary-700' : 'text-secondary-600 hover:bg-secondary-100' }}">
