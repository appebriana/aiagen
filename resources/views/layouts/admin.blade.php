        ...
        <div class="min-h-screen bg-secondary-200 flex" x-data="{ sidebarOpen: true, mobileSidebar: false, feedbackOpen: false, feedbackSuccessOpen: false, feedbackMessage: '', feedbackLoading: false }">
            ...
            <div class="lg:hidden fixed bottom-6 left-6 right-6 z-[100] bg-white/80 backdrop-blur-2xl border border-white/50 rounded-2xl shadow-[0_15px_35px_rgba(0,0,0,0.1)] px-3 py-2">
                <div class="flex items-center justify-around">
                    <a href="{{ route('admin.dashboard') }}" 
                       class="flex flex-col items-center gap-0.5 py-1 px-3 rounded-2xl transition-all {{ request()->routeIs('admin.dashboard') && !request()->is('*/ai-agen*') ? 'text-primary-600 bg-primary-50' : 'text-secondary-400' }}">
                    ...
                    <a href="{{ route('admin.pengaturan.index') }}" 
                       class="flex flex-col items-center gap-0.5 py-1 px-3 rounded-2xl transition-all {{ request()->is('*/pengaturan*') || request()->routeIs('admin.profile.*') || request()->routeIs('admin.users.*') ? 'text-primary-600 bg-primary-50' : 'text-secondary-400' }}">
