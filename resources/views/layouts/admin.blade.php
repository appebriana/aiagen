            ...
            <aside
                ...
                <nav class="flex-1 overflow-y-auto py-4 px-3 space-y-1 scrollbar-hide">
                    ...
                    <a href="{{ route('feedback.index') }}"
                       class="flex items-center gap-3 px-3 py-2.5 rounded-lg text-sm font-medium transition-colors
                              {{ request()->routeIs('feedback.index') ? 'bg-primary-700 text-white' : 'text-primary-300 hover:bg-primary-800 hover:text-white' }}">
                ...
                <div class="bg-white/90 backdrop-blur-2xl rounded-2xl shadow-[10px_10px_40px_rgba(0,0,0,0.12)] border border-white/50 flex flex-col h-full">
                    ...
                    <div class="p-5 overflow-y-auto flex-1 scrollbar-hide">
                        ...
                        <div class="flex flex-col gap-2 mb-6">
                            ...
                            <a href="{{ route('feedback.index') }}" class="flex items-center gap-4 p-3 rounded-2xl transition-all duration-300 active:scale-95 {{ request()->routeIs('feedback.index') ? 'bg-primary-600 text-white shadow-lg shadow-primary-200' : 'bg-secondary-50 text-secondary-600 hover:bg-secondary-100' }}">
