    ...
    <body class="font-sans antialiased">
        ...
        <div class="h-screen bg-secondary-200 flex overflow-hidden" 
            ...
            <div class="flex-1 flex flex-col transition-all duration-300 min-w-0 h-screen overflow-hidden" :class="sidebarOpen ? 'lg:ml-64' : 'lg:ml-20'">
                ...
                {{-- Aesthetic Left Floating Sidebar (Mobile CMS) --}}
                <div x-show="mobileSidebar" x-cloak
                    ...
                    <div class="bg-white/90 backdrop-blur-2xl rounded-2xl shadow-[10px_10px_40px_rgba(0,0,0,0.12)] border border-white/50 flex flex-col h-full">
                        ...
                        <div class="p-5 overflow-y-auto flex-1 scrollbar-hide">
                            {{-- Vertical Menu Items (Main Navigation) --}}
                            <div class="flex flex-col gap-2 mb-6">
                                <p class="px-3 text-[10px] font-bold text-primary-500 uppercase tracking-widest mb-1">Menu Utama</p>
                                
                                <a href="{{ route($routePrefix . '.dashboard') }}"
                                   class="flex items-center gap-4 p-3 rounded-2xl transition-all duration-300 active:scale-95 {{ request()->routeIs('*.dashboard') && !request()->is('*/ai-agen*') ? 'bg-primary-600 text-white shadow-lg shadow-primary-200' : 'bg-secondary-50 text-secondary-600 hover:bg-secondary-100' }}">
                                ...
                                <a href="{{ route($routePrefix . '.ai-agen.index') }}"
                                   class="flex items-center gap-4 p-3 rounded-2xl transition-all duration-300 active:scale-95 {{ (request()->is('*/ai-agen*') || request()->is('*/laporan*')) && !request()->is('*/cms*') ? 'bg-primary-600 text-white shadow-lg shadow-primary-200' : 'bg-secondary-50 text-secondary-600 hover:bg-secondary-100' }}">
                                ...
                                <div x-data="{ isLaporanOpen: {{ request()->routeIs('*.laporan.*') ? 'true' : 'false' }} }">
                                    ...
                                    <div x-show="isLaporanOpen" x-transition class="mt-2 ml-4 pl-4 border-l-2 border-primary-100 space-y-1">
                                        ...
                                        <a href="{{ route($routePrefix . '.laporan.interaksi.livechat') }}"
                            ...
                            <p class="px-3 text-[10px] font-bold text-primary-500 uppercase tracking-widest mb-4 mt-6">Departemen CMS</p>
                            
                            {{-- Search Department Mobile --}}
                            <div class="px-3 mb-4" x-data="{ searchDept: '' }">
                                <div class="relative">
                                    <input type="text" x-model="searchDept" placeholder="Cari departemen..." 
