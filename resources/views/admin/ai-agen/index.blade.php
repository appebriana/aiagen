<x-aiagen-layout>
    ...
    <div class="space-y-6">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {{-- WhatsApp (Active) --}}
            <div class="bg-white rounded-2xl shadow-sm border-2 border-primary-500 p-6 relative overflow-hidden group hover:shadow-xl transition-all duration-300">
                ...
                <div class="flex items-center justify-between">
                    <span class="text-xs font-medium text-primary-600 flex items-center gap-1">
                        <svg class="w-4 h-4" fill="currentColor" viewBox="0 0 20 20"><path fill-rule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clip-rule="evenodd"/></svg> Terintegrasi
                    </span>
