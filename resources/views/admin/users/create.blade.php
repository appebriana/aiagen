    ...
    <div class="max-w-2xl mx-auto" x-data="userForm()">
        ...
        <div class="bg-white rounded-2xl shadow-sm border border-secondary-200 overflow-hidden">
            <div class="p-6 border-b border-secondary-200 bg-secondary-50/50">
                ...
                <p class="text-sm text-secondary-500">Lengkapi detail akun untuk membuat pengguna baru.</p>
            </div>

            <form method="POST" action="{{ route('admin.users.store') }}" class="p-6 space-y-6" @submit.prevent="submitForm($event)">
                @csrf

                <!-- Name -->
                <div>
                    <x-input-label for="name" :value="__('Nama Lengkap')" class="font-bold text-secondary-700" />
                    <x-text-input id="name" class="block mt-1 w-full border-secondary-300 focus:border-primary-500 focus:ring-primary-500 rounded-xl" type="text" name="name" :value="old('name')" required autofocus autocomplete="name" placeholder="Masukkan nama lengkap" />
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <x-text-input id="username" class="block mt-1 w-full border-secondary-300 focus:border-primary-500 focus:ring-primary-500 rounded-xl" type="text" name="username" :value="old('username')" required placeholder="username" 
                            x-model="username"
                    ...
                    <div>
                        ...
                        <x-text-input id="email" class="block mt-1 w-full border-secondary-300 focus:border-primary-500 focus:ring-primary-500 rounded-xl" type="email" name="email" :value="old('email')" required placeholder="email@contoh.com" 
                            x-model="email"
                ...
                <div class="relative">
                    <x-input-label for="password" :value="__('Kata Sandi')" class="font-bold text-secondary-700" />
                        ...
                        <div class="flex justify-between items-center">
                            ...
                            <div class="flex flex-wrap gap-x-3 gap-y-1">
                                <span class="text-[10px] flex items-center gap-1" :class="rules.minLength ? 'text-green-600' : 'text-secondary-400'">
                                    <svg class="w-3 h-3" fill="currentColor" viewBox="0 0 20 20"><path fill-rule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clip-rule="evenodd"/></svg> 8+ Karakter
                                </span>
                ...
                <!-- Confirm Password -->
                <div class="relative">
                    <x-input-label for="password_confirmation" :value="__('Konfirmasi Kata Sandi')" class="font-bold text-secondary-700" />
                    <div class="relative mt-1">
