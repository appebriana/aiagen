<x-admin-layout>
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
        ...
        <div class="bg-white rounded-2xl shadow-sm border border-secondary-200 p-6">
            <div class="flex items-center gap-4">
                ...
                <div>
                    <p class="text-[10px] font-bold text-secondary-400 uppercase tracking-widest">Total Pengguna</p>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div class="lg:col-span-2 bg-white rounded-2xl shadow-sm border border-secondary-200 p-6">
            <h3 class="text-lg font-bold text-secondary-900 mb-6">Aktivitas AI (7 Hari Terakhir)</h3>
            <div class="h-[300px]">
        ...
        {{-- Top 5 Pertanyaan --}}
        <div class="bg-white rounded-2xl shadow-sm border border-secondary-200 p-6">
            <h3 class="text-lg font-bold text-secondary-900 mb-6">Top 5 Pertanyaan</h3>
            <div class="space-y-4">
    ...
    <div class="mt-8 bg-white rounded-2xl shadow-sm border border-secondary-200 overflow-hidden">
        <div class="px-6 py-4 border-b border-secondary-100 flex justify-between items-center">
            <h3 class="text-lg font-bold text-secondary-900">Pemakaian API OpenAI per Departemen</h3>
        </div>
            ...
            <table class="w-full text-left border-collapse">
                <thead>
                    <tr class="bg-secondary-50">
                        ...
                        <th class="px-6 py-4 text-[10px] font-bold text-secondary-500 uppercase tracking-widest">Pemilik</th>
                ...
                <tbody class="divide-y divide-secondary-100">
                    ...
                    <tr class="hover:bg-secondary-50/50 transition-colors">
                        ...
                        <td class="px-6 py-4">
                            <span class="text-sm text-secondary-600">{{ $stat->department->user->name ?? '-' }}</span>
                        </td>
                        <td class="px-6 py-4">
